 ...
 */
abstract class BaseChatViewHolderPres(itemView: View) : RecyclerView.ViewHolder(itemView) {
    abstract fun bind(message: MessagePres)
}

class ChatMessageOutgoingViewHolderPres(itemView: View) : BaseChatViewHolderPres(itemView) {
...
class ChatMessageIncomingViewHolderPres(itemView: View) : BaseChatViewHolderPres(itemView) {
